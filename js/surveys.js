...
function hermesAjax(url,mode,data,beforeSend) {
	if(typeof(beforeSend)!='function'){beforeSend=function(){};}
...
$(document).ready(function(){
	...
	//}
	//$jqxhr=hermesAjax('ajax.php',44,{"fname":$fname.val(),"lname":$lname.val(),"email":$email.val(),"datee":datee,"netid":$netid.val(),"checker":$checker.val()});
	//$jqxhr.done(function(data){
	//	alertDialog(data['results']+data['errmsg']);
	//	$bkgDialog.dialog('close');
	//})
})